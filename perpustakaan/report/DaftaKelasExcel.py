...
class PartnerXlsx(models.AbstractModel):
    _name = 'report.perpustakaan.report_kelas_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, supplier):
        ...
        sheet.write(1, 0, 'Nama Kelas')
        sheet.write(1, 1, 'Jurusan')
        sheet.write(1, 2, 'Fakultas')
        ...
        for obj in supplier:
            ...
            sheet.write(row, col + 1, obj.jurusan)
            sheet.write(row, col + 2, obj.fakultas)
